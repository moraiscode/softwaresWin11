...
| Nome                          | Finalidade                          | Empresa                 | Descrição                                                                 |
|-------------------------------|-------------------------------------|-------------------------|---------------------------------------------------------------------------|
| Core Temp 1.18.1             | Monitoramento de temperatura        | ALCPU                   | Monitora a temperatura da CPU em tempo real.                              |
| Libre Hardware Monitor       | Monitoramento de hardware           | Unknown                 | Monitora temperaturas, velocidades de ventiladores e voltagens do sistema. |
| MSI Afterburner 4.6.5        | Monitoramento e overclocking        | MSI                     | Monitora e ajusta configurações de placa de vídeo, incluindo overclocking. |
| NeoHtop                      | Monitoramento de processos          | Unknown                 | Versão moderna do Htop para monitoramento de processos do sistema.        |
| OCCT                         | Teste de estresse do sistema        | OCCT                    | Realiza testes de estresse em CPU, GPU e memória para verificar estabilidade. |
| OCCT.exe                     | Teste de estresse do sistema        | OCCT                    | Executável do OCCT para testes de estresse do sistema.                    |
| RivaTuner Statistics Server 7.3.6 | Monitoramento de desempenho    | Guru3D                  | Fornece estatísticas de desempenho em tempo real para jogos e overclocking. |
| SIV                          | Monitoramento de sistema            | Unknown                 | System Information Viewer, exibe informações detalhadas do sistema.       |

## Ferramentas de Informação de Hardware

| Nome                          | Finalidade                          | Empresa                 | Descrição                                                                 |
|-------------------------------|-------------------------------------|-------------------------|---------------------------------------------------------------------------|
| AIDA64 Extreme               | Diagnóstico de hardware             | FinalWire Ltd           | Fornece informações detalhadas sobre hardware e software do sistema.      |
| AIDA64 Extreme Portable 6.20.5300 | Versão portátil do AIDA64      | FinalWire Ltd           | Versão portátil do AIDA64 para diagnóstico de hardware.                   |
| CPUID CPU-Z 2.15             | Informações de hardware             | CPUID                   | Exibe informações detalhadas sobre CPU, memória e placa-mãe.              |
| CPUID HWMonitor 1.57         | Monitoramento de hardware           | CPUID                   | Monitora voltagens, temperaturas e velocidades de ventiladores.           |
| TechPowerUp GPU-Z            | Informações de GPU                  | TechPowerUp             | Fornece informações detalhadas sobre a placa de vídeo.                    |

## Development Tools

| Nome                          | Finalidade                          | Empresa                 | Descrição                                                                 |
|-------------------------------|-------------------------------------|-------------------------|---------------------------------------------------------------------------|
| 7-Zip 24.09 (x64)            | Compactação de arquivos             | Igor Pavlov             | Compacta e descompacta arquivos em diversos formatos, como ZIP e RAR.     |
| Composer - PHP Dependency Manager | Gerenciamento de dependências PHP | Nilson Lopes            | Gerencia dependências para projetos PHP.                                  |
| Git                          | Controle de versão                  | Git Project             | Sistema de controle de versão para desenvolvimento colaborativo.          |
| GitHub Desktop               | Interface para Git                  | GitHub                  | Interface gráfica para gerenciamento de repositórios Git no GitHub.       |
| HeidiSQL 12.10.0.7000        | Gerenciamento de bancos de dados    | Ansgar Becker           | Cliente gráfico para gerenciar bancos de dados MySQL, MariaDB e outros.    |
| Microsoft .NET SDK 6.0.428 (x64) | Desenvolvimento .NET            | Microsoft               | Kit de desenvolvimento para criar aplicações .NET 6.                      |
| Microsoft .NET SDK 8.0.410 (x64) | Desenvolvimento .NET            | Microsoft               | Kit de desenvolvimento para criar aplicações .NET 8.                      |
| Microsoft ASP.NET Core 8.0.14 - Shared Framework (x86) | Framework para .NET    | Microsoft               | Framework compartilhado para aplicações ASP.NET Core 8.0.                 |
| Microsoft ASP.NET Core 8.0.16 - Shared Framework (x64) | Framework para .NET    | Microsoft               | Framework compartilhado para aplicações ASP.NET Core 8.0 (64-bit).        |
| Microsoft Visual Studio Code | Editor de código                    | Microsoft               | Editor de código-fonte com suporte a várias linguagens de programação.    |
| MySQL Workbench 8.0 CE       | Gerenciamento de MySQL              | Oracle                  | Ferramenta gráfica para administração e design de bancos de dados MySQL.  |
| PostgreSQL 17                | Banco de dados relacional           | PostgreSQL Global Development Group | Sistema de banco de dados relacional de código aberto.                |
| Python 3.9.13 (64-bit)       | Linguagem de programação            | Python Software Foundation | Interpretador para a linguagem de programação Python.                 |
| Python Launcher              | Executa scripts Python              | Python Software Foundation | Facilita a execução de scripts Python em diferentes versões.         |
| XAMPP                        | Servidor local                      | Apache Friends          | Conjunto de ferramentas para criar um servidor local com Apache, MySQL, etc. |
...
| Ghostscript GPL 8.64 (Msi Setup) | Processamento de PostScript    | Artifex Software        | Interpretador para arquivos PostScript e PDF.                             |
...
| Rockstar Games SDK           | Desenvolvimento de jogos            | Rockstar Games          | Kit de desenvolvimento para integração com jogos da Rockstar.             |
...
| Pacote de Driver do Windows - libusbK Tinfoil | Driver para Tinfoil         | Unknown                 | Driver para o software Tinfoil, usado em homebrew do Nintendo Switch.     |
